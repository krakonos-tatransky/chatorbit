 ...
 *
 * Displays the privacy policy for ChatOrbit.
 */
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <Text style={styles.pageTitle} maxFontSizeMultiplier={1.2}>{t.privacy.title}</Text>
        <Text style={styles.lastUpdated} maxFontSizeMultiplier={1.2}>
          {t.privacy.lastUpdated.replace('{date}', t.privacy.lastUpdatedDate)}
        </Text>
