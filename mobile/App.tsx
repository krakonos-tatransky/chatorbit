...
import { COLORS, DEFAULT_MESSAGE_CHAR_LIMIT, SESSION_CONFIG, TIMINGS, WEBRTC_CONFIG } from './src/constants';
...
const InAppSessionScreen: React.FC<InAppSessionScreenProps> = ({
  ...
  const getPeerLogId = useCallback((pc: RTCPeerConnection | null | undefined) => {
    if (!pc) {
      return 'none';
    }
